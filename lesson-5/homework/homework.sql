...
IF EXISTS (SELECT * FROM Employees WHERE Department = 'HR' OR EmployeeID = 5)
BEGIN
    UPDATE Employees
...
(1, 'John', 'Smith', 28, 'Sales', 55000.00, '2021-05-10'),
(2, 'Sarah', 'Johnson', 24, 'Marketing', 48000.00, '2022-01-15'),
(3, 'Michael', 'Brown', 32, 'IT', 70000.00, '2020-11-03'),
(4, 'Jessica', 'Williams', 22, 'Customer Service', 42000.00, '2022-06-20'),
(5, 'David', 'Miller', 41, 'HR', 65000.00, '2018-09-12'),
(6, 'Jennifer', 'Davis', 36, 'Finance', 75000.00, '2019-03-25'),
(7, 'Robert', 'Wilson', 29, 'IT', 62000.00, '2020-07-18'),
(8, 'Lisa', 'Moore', 23, 'Marketing', 46000.00, '2022-04-05'),
(9, 'Thomas', 'Taylor', 44, 'Operations', 80000.00, '2017-12-01'),
(10, 'Emily', 'Anderson', 31, 'Sales', 59000.00, '2019-11-15');
