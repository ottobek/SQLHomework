...
SELECT EmployeeID, 
       COALESCE(FirstName, LastName) AS FirstOrLastName
FROM dbo.Employees;
...
SELECT TOP 10 p.ProductID, p.ProductName, SUM(s.SaleAmount) AS TotalSales
FROM Products p
...
INSERT INTO dbo.Employees (EmployeeID, FirstName, LastName, DepartmentName, Salary, HireDate, Age, Email, Country) VALUES
